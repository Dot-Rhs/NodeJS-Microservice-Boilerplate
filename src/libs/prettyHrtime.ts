...
/**
 * Imported from
 * https://github.com/robrich/pretty-hrtime/blob/main/index.js
 */
...
export const prettyHrtime = (source: [number, number], opts?: { verbose?: boolean; precise?: boolean }) => {
  ...
  if (source[1] < 0) {
    ...
    source[0] = parseInt(String(totalSeconds));
